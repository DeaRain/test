    ...
    <div class="container">
        <div class="infoline">
            ...
            <div class="infoline__item infoline__item_last">
                <span class="infoline__icon icon-label" style="font-size: 50px"></span>
